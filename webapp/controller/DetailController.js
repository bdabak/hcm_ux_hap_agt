  ...
  function (
    ...
    return BaseController.extend("hcm.ux.hapv3.controller.DetailController", {
      ...
      onNavBack: function (oEvent) {
        ...
        if (this.hasChanges) {
          this.confirmDialog({
            title: this.getText("formHasChanges", []),
            html: this.getText("formQuitWithoutSave", []),
            icon: "warning",
            confirmButtonText: this.getText("exitWithoutSave", []),
            confirmCallbackFn: that._doNavToMain,
          });
      ...
      _refreshSidebarFooterData: function () {
        ...
        var aResults = oViewModel.getProperty("/formData/ResultTable");
        ...
        //--New footer UX - Flip Button --//
        $.each(aResults, function(i, oResult){
          oFooterData.TableData.push({
            Label: oResult.RowName,
            Value: oResult.Value
          })
        });
        return oFooterData;
        ...
        // /*Footer Data*/
        // var aResults = _.filter(aResults, function (oResultLine) {
        ...
        // var aFinalRow = _.filter(aResults, ["Sort", "099"]);
        // var sRowIndex = 0;
        // var sColIndex = 0;
      ...
      _getDocumentDetail: function () {
        ...
        this.openBusyFragment("formDetailPrepared", []);
        this._unregisterSaveShortcut();
        oModel.read(sQuery, {
          urlParameters: {
            $expand: sExpand,
      ...
      _buildUINew: function () {
        ...
        $.each(aTabs, function (sIndex, oTab) {
          if (
            ...
            if (
              oCell[0].ValueString !== "" &&
              parseFloat(oCell[0].ValueNum) !== 100
            ) {
              sName =
                oElement.Name +
                " (%" +
      ...
      _buildObjectTitle: function (oElement) {
        ...
        var _isFieldVisible = function (
          sCellValueAvailability,
          sValue,
          sColumnIid
        ) {
          if (sColumnIid === that._sWeightColumn) {
            try {
              if (parseFloat(sValue) === 100) {
                return false;
              }
            } catch (e) {
              //Continue for other check
            }
          }
            ...
            new ResultBoard({
              ...
              visible: {
                parts: [
                  ...
                  {
                    path: `formDetailsModel>/bodyCells/${oElement.RowIid}/${that._sWeightColumn}/ColumnIid`,
                  },
                ],
            ...
            new ResultBoard({
              ...
              visible: {
                parts: [
                  ...
                  {
                    path: `formDetailsModel>/bodyCells/${oElement.RowIid}/${that._sFinAppColumn}/ColumnIid`,
                  },
                ],
            ...
            new ResultBoard({
              ...
              visible: {
                parts: [
                  ...
                  {
                    path: `formDetailsModel>/bodyCells/${oElement.RowIid}/${that._sFinOthColumn}/ColumnIid`,
                  },
                ],
            ...
            new ResultBoard({
              ...
              visible: {
                parts: [
                  ...
                  {
                    path: `formDetailsModel>/bodyCells/${oElement.RowIid}/${that._sEmpAppColumn}/ColumnIid`,
                  },
                ],
                formatter: _isFieldVisible,
              },
      ...
      _addSection: function (oViewData, oPageLayout, sRowIid) {
        ...
        var oWeighting = new sap.ui.core.CustomData({
          key: "weighting",
          value: {
            path: sWeightingPath,
          },
        ...
        var oSection = new sap.uxap.ObjectPageSection({
          ...
          .addStyleClass("sapUiNoContentPadding")
          .addStyleClass("hapShowWeighting");
      ...
      _getElementButtons: function (oElem, sElementEditable) {
        ...
        if (oElem.AttachmentVisible) {
          ...
          var oAttButton = new sap.m.Button({
            ...
            tooltip: "{i18n>addAttachmentFileTooltip}",
      ...
      _addRowHeader: function (oParent, oElem) {
        ...
        var _isWeigthingVisible = function (sCellValueAvailability, sValue) {
          if (
            sCellValueAvailability !== null &&
            sCellValueAvailability !== undefined
          ) {
        ...
        var oRB = new ResultBoard({
          status: "Error",
          result: {
            parts: [
              {
                path: `formDetailsModel>/bodyCells/${oElem.RowIid}/${that._sWeightColumn}/ValueNum`,
                type: "sap.ui.model.type.Float",
                formatOptions: {
                  maxFractionDigits: 2,
                },
          ...
          visible: {
            parts: [
              {
                path: `formDetailsModel>/bodyCells/${oElem.RowIid}/${that._sWeightColumn}/CellValueAvailability`,
              },
              {
                path: `formDetailsModel>/bodyCells/${oElem.RowIid}/${that._sWeightColumn}/ValueNum`,
              },
            ],
            formatter: _isWeigthingVisible,
          },
        })
          .addStyleClass("sapUiTinyMarginBegin")
          .addStyleClass("smod-result-board-bgcolor");

        oPanelToolbar.addContent(oPanelHeader);
        oPanelToolbar.addContent(oRB);
      ...
      _addCellsNew: function (oParent, sRowIid, oViewData) {
        ...
        $.each(oViewData.formData["BodyColumns"], function (sIndex, oColumn) {
          if (oViewData.bodyCells[sRowIid].hasOwnProperty(oColumn.ColumnIid)) {
            ...
            if (
              oCell.ColumnIid === that._sObjExvColumn ||
              oCell.ColumnIid === that._sObjMxvColumn
            ) {
              return;
            }
            ...
            if (
              ...
              if (
                ...
                if (oCell.ColumnIid === that._sObjMnvColumn) {
                  oEL = new sap.m.Label({
                    text: {
                      parts: [
                        {
                          path: `formDetailsModel>/bodyCells/${oCell.RowIid}/${that._sObjMnvColumn}/Caption`,
                        },
                        { value: "/" },
                        {
                          path: `formDetailsModel>/bodyCells/${oCell.RowIid}/${that._sObjExvColumn}/Caption`,
                        },
                        { value: "/" },
                        {
                          path: `formDetailsModel>/bodyCells/${oCell.RowIid}/${that._sObjMxvColumn}/Caption`,
                        },
                        { value: ":" },
                      ],
                    },
              ...
              case "S":
                ...
                switch (oCell.LayoutType) {
                  case "S":
                    ...
                    if (oCell.CellValueClass === "ZQ") {
                      oEl = this._addResultBoard(oCell);
                    } else if (oCell.ColumnIid === that._sFinAppColumn) {
                      oEl = this._addInputRange(oCell, "ValueString");
                    } else {
            ...
            if (oCell.ColumnIid === that._sObjSccColumn) {
              ...
              var oTA = new sap.m.TextArea({
                ...
                editable: {
                  parts: [
                    { path: sCellNoteEditablePath },
                    { path: sCellNoteColumnIid },
                  ],
                  formatter: function (sCellNoteAvailability, sColumnIid) {
                    if (sColumnIid === that._sObjColumn) {
                      return false;
                    }
                    if (
                      sCellNoteAvailability === "X" ||
      ...
      _addNewElementFreeFormCells: function (
        ...
        $.each(aNewCells, function (i, oCell) {
          ...
          if (oColumn) {
            if (
              oColumn.ColumnIid === that._sObjExvColumn ||
              oColumn.ColumnIid === that._sObjMxvColumn ||
              oColumn.ColumnIid === that._sObjRvlColumn ||
              oColumn.ColumnIid === that._sFinAppColumn
            ) {
              return;
            }
      ...
      _addInputRange: function (oCell, sBindingField) {
        var that = this;
        var oViewModel = this.getModel("formDetailsModel");
        var d =
          oCell.CellValueClass === "S" && oCell.CellValueType === "9" ? 0 : 2;

        var oIR = new RatingRange({
          min: "0",
          max: "100",
          decimal: d,
          value: {
      ...
      _getInputFieldByColumnId: function (oCell, sBindingField, sColumnIid) {
        var oViewModel = this.getModel("formDetailsModel");
        var that = this;

        var oIF = new sap.m.Input({
          value: {
            path: `formDetailsModel>/bodyCells/${oCell.RowIid}/${sColumnIid}/${sBindingField}`,
          },
          fieldWidth: "30%",
          placeholder: {
            parts: [
              {
                path: `formDetailsModel>/bodyCells/${oCell.RowIid}/${sColumnIid}/ColumnIid`,
              },
              {
                path: `formDetailsModel>/bodyCells/${oCell.RowIid}/${sColumnIid}/Caption`,
              },
            ],
            formatter: function (c, t) {
              switch (c) {
                case that._sObjMnvColumn:
                case that._sObjExvColumn:
                case that._sObjMxvColumn:
                  return t;
                default:
                  return null;
              }
          ...
          description: {
            parts: [
              {
                path: `formDetailsModel>/bodyCells/${oCell.RowIid}/${sColumnIid}/ValueTextAvailable`,
              },
              {
                path: `formDetailsModel>/bodyCells/${oCell.RowIid}/${sColumnIid}/CellValueClass`,
              },
              {
                path: `formDetailsModel>/bodyCells/${oCell.RowIid}/${sColumnIid}/ValueText`,
              },
            ],
          ...
          change: function (oEvent) {
            if (oCell.CellValueClass === "ZS" || oCell.CellValueClass === "S") {
              ...
              oViewModel.setProperty(
                `formDetailsModel>/bodyCells/${oCell.RowIid}/${sColumnIid}/${sBindingField}`,
                val
              );
            }
            if (sColumnIid === that._sObjRvlColumn) {
              that._triggerValueDetermination();
            }
          },
          submit: function () {},
          editable: {
            parts: [
              {
                path: `formDetailsModel>/bodyCells/${oCell.RowIid}/${sColumnIid}/CellValueAvailability`,
              },
              {
                path: `formDetailsModel>/bodyCells/${oCell.RowIid}/${sColumnIid}`,
              },
            ],
            formatter: that._getCellEditable.bind(that),
          },
      ...
      _addInputField: function (oCell, sBindingField) {
        ...
        if (oCell.ColumnIid === that._sObjMnvColumn) {
          oIF = new sap.m.HBox({
            items: [
              that
                ._getInputFieldByColumnId(
                  oCell,
                  sBindingField,
                  that._sObjMnvColumn
                )
                .addStyleClass("hapLimitValues"),
              that
                ._getInputFieldByColumnId(
                  oCell,
                  sBindingField,
          ...
          }).addStyleClass("hapFlexSmallGap");
        } else {
          oIF = this._getInputFieldByColumnId(
            oCell,
            sBindingField,
            oCell.ColumnIid
          );
      ...
      _getCellEditable: function (sCellValueAvailability, oCell) {
        try {
          if (
            oCell.ColumnIid === this._sObjUniColumn ||
            oCell.ColumnIid === this._sObjDirColumn ||
            oCell.ColumnIid === this._sObjColumn
          ) {
            return false;
          }
      ...
      _addListBox: function (oCell) {
        ...
        var oLB = new sap.m.Select({
          ...
          editable: {
            ...
            //     sCellValueAvailability === "R"
            //   ) {
            //     return that._getCellEditable(oCell);
            //   } else {
            //     return false;
            //   }
            // },
          ...
          change: function (oEvent) {
            ...
            if (oSelItem) {
              ...
              if (sColumnIid === that._sObjIndColumn) {
                var w = "0.000";
                try {
                  if (sValueIid === "0001") {
                    w = parseFloat(
                      oViewData.formParameters["IND_OBJECTIVE_FWGT"]
                    ).toFixed(3);
                  } else if (sValueIid === "0002") {
                    w = parseFloat(
                      oViewData.formParameters["PRT_OBJECTIVE_FWGT"]
                    ).toFixed(3);
                  }
                  var sWeightingPath = `/bodyCells/${sRowIid}/${that._sWeightColumn}`;
                  var oWeightingCell = oViewModel.getProperty(sWeightingPath);
                  var sWeightInd = _.findIndex(aBodyCells, {
                    RowIid: sRowIid,
                    ColumnIid: that._sWeightColumn,
                  }) || null;
                  if (oWeightingCell && sWeightInd !== null) {
                    oWeightingCell.ValueNnv = aBodyCells[sWeightInd].ValueNnv =
                      "";
                    oWeightingCell.ValueText = aBodyCells[
                      sWeightInd
                    ].ValueText = "";
                    oWeightingCell.ValueString = aBodyCells[
                      sWeightInd
                    ].ValueString = formatter.formatWeighting(w, 3, false);
                    oWeightingCell.ValueTxt = aBodyCells[sWeightInd].ValueTxt =
                      formatter.formatWeighting(w, 3, false);
                    oWeightingCell.ValueNum = aBodyCells[sWeightInd].ValueNum =
                      w;
                    oViewModel.setProperty(sWeightingPath, oWeightingCell);

                    if(formatter.formatWeighting(w)){
                      that.toastMessage({
                        text: that.getText("weightingIsSet", [formatter.formatWeighting(w,2,false)]),
                        icon: "success",
      ...
      _checkTrainingSelection: function (sRowIid, sBindingReference) {
        ...
        if (sCount >= 1) {
          ...
          this.toastMessage({
            text: this.getText("maxSelectionsReached", [1]),
            icon: "warning",
      ...
      _handleResetSurvey: function (sRowIid, sFormId, sBindingReference) {
        ...
        var _doResetSurvey = function (oEvent) {
          ...
          that.toastMessage({
            text: that.getText("surveyIsReset", []),
          });
        };
        ...
        var _cancelResetSurvey = function (oEvent) {
          ...
          that.toastMessage({
            text: that.getText("surveyResetCancelled", []),
          });
          // that.confirmDialog.close();
        };

        this.confirmDialog({
          title: this.getText("surveyResetConfirm", []),
          html: this.getText("surveyResetQuestion", [sSurveyName]),
          icon: "warning",
          confirmButtonText: this.getText("surveyDoReset", []),
          confirmCallbackFn: _doResetSurvey,
          cancelButtonText: this.getText("surveyDoReset", []),
          cancelCallbackFn: _cancelResetSurvey,
        });
      ...
      onSurveyFinished: function () {
        ...
        if (sSurveyIncompleted) {
          ...
          this.toastMessage({
            text: this.getText("allQuestionsMustBeFilled", [1]),
            icon: "warning",
            showConfirmButton: true,
            timer: undefined,
          });
      ...
      _formBodyColumnsObject: function () {
        ...
        $.each(aBodyColumns, function (i, oColumn) {
          ...
          if (oColumn.ColumnId === "ZO00") {
            /* ZO00	Hedef Yönü */
            that._sObjDirColumn = oColumn.ColumnIid;
          }
          ...
          if (oColumn.ColumnId === "ZO04") {
            that._sObjMnvColumn = oColumn.ColumnIid;
            /* ZO04	Alt Sınır */
          }

          if (oColumn.ColumnId === "ZO03") {
            that._sObjExvColumn = oColumn.ColumnIid;
            /* ZO03	Beklenen Değer */
          }

          if (oColumn.ColumnId === "ZO06") {
            that._sObjMxvColumn = oColumn.ColumnIid;
            /*ZO04	Üst Sınır */
          }
      ...
      _handleSaveAndContinue: function () {
        ...
        this._removeAllMessages();
        this.openBusyFragment("formSaved", []);
        oModel.create("/DocumentOperationsSet", oOperation, {
          success: function (oData, oResponse) {
            sHasErrors = that._processReturnMessages(
              oData.Return.results,
      ...
      _handleCheckDocument: function () {
        ...
        this.openBusyFragment("formCheckInProgress", []);
        oModel.create("/DocumentOperationsSet", oOperation, {
          success: function (oData, oResponse) {
            /* Return messages */
            sHasErrors = that._processReturnMessages(
            ...
            if (sHasErrors === false) {
              ...
              that.toastMessage({
                text: that.getText("formCheckSuccess", []),
              });
            }
          },
          error: function (oError) {
      ...
      _handleSaveDocument: function (bExit, bAuto = false) {
        ...
        this.openBusyFragment(bAuto ? "formAutoSaved" : "formSaved", []);
        ...
        oModel.create("/DocumentOperationsSet", oOperation, {
          success: function (oData, oResponse) {
            ...
            if (sHasErrors === false) {
              ...
              that.toastMessage({
                text: that.getText("formSaveSuccess", []),
                icon: "success",
              });
              that._setChangeListeners(false);
              if (bExit) {
      ...
      _handleDeleteFormElement: function (oEvent) {
        ...
        this.confirmDialog({
          title: this.getText("elementDeletionConfirm", []),
          html: this.getText("elementDeletionQuestion", [sElementName]),
          icon: "warning",
          confirmButtonText: this.getText("elementDelete", []),
          confirmCallbackFn: _callRowDelete,
        });
      ...
      _processReturnMessages: function (aReturn, bShowMessages, sButtonId) {
        ...
        if (aFormMessages.length > 0 && bShowMessages) {
          ...
          that.toastMessage({
            text: that.getText("formCheckError", []),
          });
      ...
      onOpenFormMessagePopover: function (oEvent) {
        var oViewModel = this.getModel("formDetailsModel");
        var aFormMessages = oViewModel.getProperty("/formMessages");

        var htmlContent = "<div class='smod-error-pane'>";

        $.each(aFormMessages, function (i, oMessage) {
          htmlContent =
            htmlContent +
            `<div class='smod-error-pane-row'><div class='smod-error-pane-cell'>${oMessage.Message}</div></div>`;
        });

        htmlContent = htmlContent + "</div>";

        this.toastMessage({
          title: this.getText("formMessages", []),
          toast: false,
          html: htmlContent,
          showConfirmButton: true,
          ...
          position: "center",
          customClass: {
            htmlContainer: "swal2-html-message-container",
          },
          iconColor: undefined,
        });
        ...
        oModel.create("/DocumentOperationsSet", oOperation, {
          success: function (oData, oResponse) {
            ...
            if (!sHasErrors && !sNoMsg) {
              ...
              that.toastMessage({
                text: that.getText("elementDeleteSuccessful", []),
                icon: "success",
              });
            }
      ...
      _handleDeleteAttachment: function (oEvent) {
        ...
        var _callAttachmentDelete = function () {
          // that.confirmDialog.close();
          that.openBusyFragment("attachmentBeingDeleted");
          oModel.remove(sPath, {
            success: function (oData, oResponse) {
              that._refreshAttachmentList();
              that.closeBusyFragment();
              ...
              that.toastMessage({
                text: that.getText("attachmentDeleteSuccess", []),
                icon: "success",
              });
            },
            error: function (oError) {
              ...
              that.toastMessage({
                text: that.getText("attachmentDeleteError", []),
                icon: "error",
              });
            },
          });
        ...
        this.confirmDialog({
          title: this.getText("attachmentDeletionConfirm", []),
          html: this.getText("attachmentDeletionQuestion", [sAttachmentName]),
          icon: "warning",
          confirmButtonText: this.getText("elementDelete", []),
          confirmCallbackFn: _callAttachmentDelete,
        });
      ...
      onDependentObjectiveSearch: function (oEvent) {
        var that = this;
        ...
        oModel.create("/DocumentOperationsSet", oOperation, {
          success: function (oData, oResponse) {
            ...
            if (!sHasErrors) {
              ...
              oWizardSettings = that._buildDependentObjectiveTree(
                oData,
                oWizardSettings
              );
      ...
      _handleAddObjectiveByWizard: function (oEvent) {
        ...
        if (sMaxChildren > 0) {
          this.toastMessage({
            ...
            text: this.getText("newElementMaxChildrenReached", [
              sMaxChildren,
              sElementName,
            ]),
            icon: "warning",
      ...
      _checkObjectiveByWizard: function () {
        ...
        var sObjDirPath = `/bodyCells/${sNewRowIid}/${this._sObjDirColumn}/ValueString`;
        var sObjDir = oViewModel.getProperty(sObjDirPath);
      ...
      onObjectiveWizardGoReview: function () {
        if (this._oWizard) {
          if (this._checkObjectiveByWizard()) {
            ...
            this.toastMessage({
              text: this.getText("checkErrorsBeforeProceeding", []),
              icon: "error",
              showConfirmButton: true,
              timer: undefined,
              position: "center",
      ...
      onObjectiveWizardFinalize: function () {
        if (typeof this._addElementCallBack === "function") {
          ...
          if (oNewElement && oNewElement?.Name) {
            this.toastMessage({
              text: this.getText("newElementAdded", [oNewElement.Name]),
              icon: "success",
            });
        ...
        if (this._objWizardDialog) {
          ...
          this._handleSaveDocument(false, false);
        }
      },
      ...
      onObjectiveWizardCancelled: function () {
        ...
        this.toastMessage({
          text: this.getText("addOperationCancelled", []),
        });
      ...
      _setObjectiveInformationFromDependent: function (oRow) {
        ...
        var sObjDirPath = `/bodyCells/${sNewRowIid}/${this._sObjDirColumn}/ValueString`;
        oViewModel.setProperty(sObjDirPath, oRow.Objdr);

        var sObjForeignType = `/bodyElements/${sNewRowIid}/ForeignType`;
        oViewModel.setProperty(sObjForeignType, oRow.Otype);

        var sObjForeignId = `/bodyElements/${sNewRowIid}/ForeignId`;
        oViewModel.setProperty(sObjForeignId, oRow.Objid);
      ...
      _getObjectiveDirectionText: function (sObjDir) {
        var oViewModel = this.getModel("formDetailsModel");
        var sNewRowIid = oViewModel.getProperty(
          "/objectiveWizardSettings/newRowIid"
        );
        var aCellValues = oViewModel.getProperty(
          `/bodyCellValues/${sNewRowIid}/${this._sObjDirColumn}/CellValues`
        );
        ...
        try {
          if (
            ...
            return _.find(aCellValues, ["ValueEid", sObjDir])["ValueText"];
          } else {
            return "";
          }
        } catch (e) {
      ...
      _handleAddFormElement: function (oEvent) {
        ...
        this.openBusyFragment("newElementInformation", [sElementName]);
        oModel.create("/DocumentOperationsSet", oOperation, {
          success: function (oData, oResponse) {
            /* Close busy indicator*/
            that.closeBusyFragment();
      ...
      _enhanceDocumentFromCatalog: function (aSelectedObjects) {
        ...
        if (aSelectedObjects.length > 0 && sSpace !== null) {
          if (aSelectedObjects.length > sSpace) {
            this.toastMessage({
              text: this.getText("maxChildSelectionReached", [
                sSpace,
        ...
        this.openBusyFragment("newElementIsAdded");
        oModel.create("/DocumentOperationsSet", oOperation, {
          success: function (oData, oResponse) {
            /* Close busy indicator*/
            that.closeBusyFragment();
      ...
      _buildDependentObjectiveTree: function (oData, oWizardSettings) {
        ...
        return _.cloneDeep(oWizardSettings);
      },
      ...
      _doEnhanceDocumentFromCatalog: function (aNewElements, sRowIid) {
        ...
        if (aNewElements.length === 1) {
          ...
          // );
          this.toastMessage({
            text: this.getText("newElementAdded", [aNewElements[0].Name]),
          });
          ...
          // );
          this.toastMessage({
            text: this.getText("newElementsAdded", [aNewElements.length]),
          });
        }
      },
      ...
      _checkMandatoryStatusNote: function (sButtonId) {
        ...
        oModel.create("/DocumentOperationsSet", oOperation, {
          ...
          error: function (oError) {
            that.closeBusyFragment();
            that.toastMessage({
              text: that.getText("formStatusChangeError", []),
              icon: "error",
              showConfirmButton: true,
              timer: undefined,
            });
      ...
      _doChangeFormStatus: function (sButtonId) {
        ...
        this.openBusyFragment("formStatusChange");
        oModel.create("/DocumentOperationsSet", oOperation, {
          success: function (oData, oResponse) {
            /* Close busy indicator*/
            that.closeBusyFragment();
            ...
            if (!sHasErrors) {
              ...
              that.toastMessage({
                text: that.getText("formStatusChangeSuccessful", []),
              });
      ...
      _handleButtonAction: function (oButton) {
        ...
        if (sFormId !== "" && sFormId !== null) {
          ...
          if (sSurveyIncompleted) {
            this.confirmDialog({
              title: this.getText("surveyNotice", []),
              html: this.getText("surveyShouldBeFilled", []),
              icon: "warning",
              confirmButtonText: this.getText("fillSurvey", []),
              confirmCallbackFn: _doCallSurvey,
              cancelButtonText: this.getText("continueWithoutFilling", []),
              cancelCallbackFn: _doChangeStatus,
            });
      ...
      _handleChangeStatusWithNote: function (oButton) {
        ...
        var doChangeStatusWithNote = function () {
          var sNote = "";
          try {
          ...
          if (sStatusNoteAvailability === "M" && sNote === "") {
            that.toastMessage({
              text: that.getText("STATUS_CHANGE_NOTE_MANDATORY", []),
              icon: "warning",
            });
        ...
        this.confirmDialog({
          title: this.getText("STATUS_CHANGE_NOTE_TITLE", []),
          html: null,
          icon: "warning",
          confirmButtonText: sButtonText,
          confirmCallbackFn: doChangeStatusWithNote,
          showConfirmButton: true,
          ...
          input: "textarea",
          inputLabel: null,
          inputPlaceholder: this.getText("STATUS_CHANGE_NOTE_PLACEHOLDER", []),
          inputAttributes: {
            "aria-label": this.getText("STATUS_CHANGE_NOTE_PLACEHOLDER", []),
          },
          preConfirm: function (value) {
            ...
            if (sStatusNoteAvailability === "M" && sNote === "") {
              Swal.showValidationMessage(
                that.getText("STATUS_CHANGE_NOTE_MANDATORY", [])
              );
              return false;
            }
            oViewModel.setProperty("/statusChangeNote", sNote);
            return true;
          },
        });
      },
      _handleChangeStatus: function (sButtonId) {
        ...
        this.confirmDialog({
          title: this.getText("formStatusChangeConfirm", []),
          html: this.getText("formStatusChangeQuestion", []),
          icon: "warning",
          confirmButtonText: this.getText("doFormStatusChange", []),
          confirmCallbackFn: _doChangeStatus,
          showConfirmButton: true,
          showCancelButton: true,
          allowOutsideClick: false,
          allowEscapeKey: false,
      ...
      _handlePrintDocument: function (oButton) {
        ...
        that.toastMessage({
          text: this.getText("lastSavedPrintOutNotification", []),
          icon: "warning",
          timer: undefined,
          showConfirmButton: true,
      ...
      onApplyAddElementCatalog: function (oEvent) {
        ...
        if (aSelectedObjects.length > 0) {
          ...
          this.toastMessage({
            text: this.getText("noElementSelected", []),
            icon: "warning",
          });
        }
      },
      ...
      onApplyAddElementFree: function () {
        ...
        this.toastMessage({
          text: this.getText("newElementAdded", [oNewElement.Value]),
        });
      },
      ...
      onSelectObjective: function (oEvent) {
        ...
        try {
          ...
          if (!_.isEmpty(oObjTeam)) {
            ...
            this.toastMessage({
              text: this.getText("teamObjectiveExist", []),
              icon: "warning",
            });
          }
          if (typeof this._addElementCallBack === "function") {
      ...
      onApplyAddElementObjective: function (oEvent) {
        ...
        if (aContexts) {
          if (aContexts.length > 1) {
            ...
            this.toastMessage({
              text: this.getText("maxObjectiveSelection", []),
              icon: "error",
              showConfirmButton: true,
              timer: undefined,
            });
      ...
      onFileTypeMissmatch: function (oEvent) {
        ...
        this.toastMessage({
          text: this.getText("fileTypeMismatch", [
      ...
      onAttachmentUploadPress: function (oEvent) {
        ...
        if (!oFileUploader.getValue()) {
          ...
          this.toastMessage({
            text: this.getText("fileSelectionRequired", []),
            icon: "error",
          });
          return;
        }
        ...
        this.openBusyFragment("fileBeingUploaded");
      ...
      onAttachmentUploadComplete: function (oEvent) {
        ...
        if (sStatus == "201" || sStatus == "200") {
          this.toastMessage({
            text: this.getText("fileUploadSuccess", []),
            icon: "success",
          });
          ...
          this.toastMessage({
            text: this.getText("fileUploadError", [sResponse]),
            icon: "error",
            showConfirmButton: true,
            timer: undefined,
          });
      ...
      onAttachmentFileChange: function (oEvent) {
        ...
        // );
        this.toastMessage({
          text: this.getText("fileUploadWarning", [
      ...
      onFileSizeExceed: function (oEvent) {
        this.toastMessage({
          text: this.getText("fileSizeExceeded", [
      ...
      onCloseUploadFormDialog: function () {
        ...
        this.toastMessage({
          text: this.getText("fileUploadCancelled", []),
        });
        this._oUploadAttachmentDialog.close();
      },
      /**
