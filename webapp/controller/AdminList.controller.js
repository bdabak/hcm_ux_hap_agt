  ...
  function (
    ...
    return BaseController.extend("hcm.ux.hapv3.controller.AdminList", {
      ...
      performFormDelete: function () {
        ...
        this.openBusyFragment("formDeleteInProgress", []);
      ...
      performChangeStatus: function (sNewStatusKey) {
        ...
        this.openBusyFragment("changeStatusInProgress", []);
        oModel.create("/AdminOperationSet", oRequest, {
          success: function (oData, oResponse) {
            that.closeBusyFragment();
      ...
      onSaveRoleChange: function () {
        ...
        this._changeRoleFragment.close();
        this.openBusyFragment("roleChangeInProgress", []);
        oModel.create("/AdminOperationSet", oRequest, {
          success: function (oData, oResponse) {
            that.closeBusyFragment();
      ...
      onApproveCreateNewForm: function () {
        ...
        this.openBusyFragment("newFormCreateInProgress", []);
        oModel.create("/AdminOperationSet", oRequest, {
          success: function (oData, oResponse) {
            that.closeBusyFragment();
